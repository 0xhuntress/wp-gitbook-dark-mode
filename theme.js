            ...
            function (e, t, n) {
                !(function (e, n) {
                        ...
                        for (var n, r, o = [], i = 0, a = e.length; i < a; i++)
                            (r = e[i]),
                                r.style &&
                                    ((n = r.style.display),
                                    t
                                        ? ("none" === n && ((o[i] = Fe.get(r, "display") || null), o[i] || (r.style.display = "")), "" === r.style.display && We(r) && (o[i] = g(r)))
                                        ...
                                        (n = a[t]),
                                            ...
                                            a !== r &&
                                                (l && r && (de.isPlainObject(r) || (o = de.isArray(r)))
                                                    ? (o ? ((o = !1), (i = n && de.isArray(n) ? n : [])) : (i = n && de.isPlainObject(n) ? n : {}), (a[t] = de.extend(l, i, r)))
                                                    : void 0 !== r && (a[t] = r));
                            return a;
                        }),
                        de.extend({
                            ...
                            (E = t.tokenize = function (e, n) {
                                ...
                                for (s = e, u = [], l = T.preFilter; s; ) {
                                    (r && !(o = ue.exec(s))) || (o && (s = s.slice(o[0].length) || s), u.push((i = []))),
                                        (r = !1),
                                        (o = le.exec(s)) && ((r = o.shift()), i.push({ value: r, type: o[0].replace(se, " ") }), (s = s.slice(r.length)));
                        ...
                        (I.propHooks = {
                            _default: {
                                ...
                                set: function (e) {
                                    de.fx.step[e.prop]
                                        ? de.fx.step[e.prop](e)
                                        : 1 !== e.elem.nodeType || (null == e.elem.style[de.cssProps[e.prop]] && !de.cssHooks[e.prop])
                                        ? (e.elem[e.prop] = e.now)
                                ...
                                return "boolean" == typeof t && "string" === n
                                    ...
                                    : this.each(function () {
                                          ...
                                          if ("string" === n) for (r = 0, o = de(this), i = e.match(qe) || []; (t = i[r++]); ) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
                                              ...
                                              (void 0 !== e && "boolean" !== n) ||
                                                  ((t = X(this)), t && Fe.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : Fe.get(this, "__className__") || ""));
                                      });
                            },
                            hasClass: function (e) {
                                var t,
                    ...
                    de.fn.extend({
                        val: function (e) {
                                ...
                                o = this[0];
                            {
                                ...
                                if (o)
                                    return (
                                        (t = de.valHooks[o.type] || de.valHooks[o.nodeName.toLowerCase()]),
                    ...
                    de.extend(de.event, {
                        ...
                        de.each("blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu".split(" "), function (
                            e,
                            t
                        ) {
                                ...
                                (f = de.event && d.global),
                                    ...
                                    d.hasContent
                                        ...
                                        : ((h = d.url.slice(i.length)),
                                          d.data && ((i += (jt.test(i) ? "&" : "?") + d.data), delete d.data),
                                          d.cache === !1 && ((i = i.replace(Ot, "$1")), (h = (jt.test(i) ? "&" : "?") + "_=" + kt++ + h)),
                                          (d.url = i + h)),
                                ...
                                if (i)
                                    return i.getClientRects().length
                                        ? ((r = i.getBoundingClientRect()),
                                          r.width || r.height ? ((o = i.ownerDocument), (n = Z(o)), (t = o.documentElement), { top: r.top + n.pageYOffset - t.clientTop, left: r.left + n.pageXOffset - t.clientLeft }) : r)
                                        : { top: 0, left: 0 };
                            },
                            position: function () {
                                if (this[0]) {
                                    ...
                                    return (
                                        "fixed" === de.css(n, "position")
                                            ...
                                            : ((e = this.offsetParent()),
                                              ...
                                              (r = { top: r.top + de.css(e[0], "borderTopWidth", !0), left: r.left + de.css(e[0], "borderLeftWidth", !0) })),
        ...
        10: [
            function (e, t, n) {
                ...
                var o = e("./dropdown"),
                    ...
                    s = e("./toolbar"),
                    u = window.gitbook;
                u.events.on("start", r), (u.keyboard = i), (u.sidebar = a), (u.toolbar = s);
            },
            { "./dropdown": 9, "./keyboard": 11, "./sidebar": 15, "./toolbar": 16 },
        ],
        11: [
            function (e, t, n) {
                function r(e, t) {
                        ...
                        .Deferred(function (e) {
                            w.ajax({
                                ...
                                success: function (n, i, s) {
                                    ...
                                    f.toggleClass("with-summary", w(".book").hasClass("with-summary")),
